#!/usr/bin/env python3
"""
Generates PLY files for each object/material
...
def create_scene_meshes(output_dir):
    ...
    # Write combined PLY
    combined_path = os.path.join(output_dir, 'room_combined.ply')
...
if __name__ == "__main__":
    ...
    print("Combined PLY: room_combined.ply")
